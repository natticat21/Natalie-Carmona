...
export var wallSound = new soundFile("sprinkle.mp3"); //load sound
soundArray.push(wallSound); //add sound to list of sounds

export var paddleSound = new soundFile("sprinkle.mp3");
soundArray.push(paddleSound);

export var scoreSound = new soundFile("sprinkle.mp3");
